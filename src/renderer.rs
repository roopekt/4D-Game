...
impl Renderer {
    ...
    pub fn render_frame(&self, world: &World, global_data: &mut GlobalData) {
        ...
        for mesh in &world.static_scene {
            ...
            let vertex_block_buffer = vertex_block.get_glium_uniform_buffer(&self.display);
            ...
            let fragment_block_buffer = fragment_block.get_glium_uniform_buffer(&self.display);
